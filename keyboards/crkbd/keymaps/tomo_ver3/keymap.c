...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|-----------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+---------+--------+--------+---------------|
                                          GUIDEL, LT(3, KC_SPC), SF2SP,   SF2SP, LT(2, KC_ENT), KC_RALT
                                         //`--------------------------'  `--------------------------'
  ...
  //|---------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_LCTL, KC_SLSH, KC_DOT,  KC_COMM, KC_MINS, KC_EQL,                       KC_COLN, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,
  //|---------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      _______, XXXXXXX, XXXXXXX, XXXXXXX, KC_UNDS, KC_PLUS,                      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,
  //|---------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
  ...
  //|---------+--------+---------+--------+--------+--------|                     |--------+--------+--------+--------+--------+--------|
      KC_LCTL, KC_SLSH, KC_DOT,   KC_COMM, KC_MINS, KC_EQL,                        KC_COLN, KC_QUOT, KC_TILD, KC_LBRC, KC_RBRC, KC_PIPE,
  //|---------+--------+---------+--------+--------+--------|                     |--------+--------+--------+--------+--------+--------|
      _______, KC_QUES, KC_LABK,  KC_RABK, KC_UNDS, KC_PLUS,                       XXXXXXX, KC_DQT,  _______, _______, _______, _______,
  //|---------+--------+---------+--------+--------+--------+--------|  |---------+--------+--------+--------+--------+--------+--------|
                                            KC_LGUI, KC_LSFT,  SFTSP,    JIS_TO_US, XXXXXXX, US_TO_JIS
                                        //`--------------------------'  `-----------------------------'
  ),
