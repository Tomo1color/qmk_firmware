...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|-----------+--------+--------+--------+--------+--------|                    |--------+--------+---------+--------+--------+---------------|
      CTR2TB,    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                          KC_H,   KC_J,    KC_K,     KC_L,    KC_SCLN, KC_ENT,
  //|-----------+--------+--------+--------+--------+--------|                    |--------+--------+---------+--------+--------+---------------|
      SF2DE,     KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                          KC_N,   KC_M,    KC_COMM,  KC_DOT,  KC_SLSH, KC_SLSH,
  //|-----------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+---------+--------+--------+---------------|
                                         KC_LGUI, LT(1, KC_ENT), SF2SP,   SF2SP, MO(2), KC_RALT
                                         //`--------------------------'  `--------------------------'
