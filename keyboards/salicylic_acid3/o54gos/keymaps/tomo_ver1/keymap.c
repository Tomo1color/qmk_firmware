...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        CTR2TB,    SF2F12, SGUI_L, GUI_BS,  KC_LGUI, KC_NO,    KC_NO,    KC_NO,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_MINS, KC_ENT,
    ...
    [3] = LAYOUT(
        ...
        KC_LCTL,   KC_F12, KC_F11, KC_F10,  KC_LGUI, KC_NO,    KC_NO,    KC_NO,  KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_NO,   KC_ENT,
        KC_LSFT,   KC_NO,  KC_NO,  KC_NO,   KC_NO,   KC_NO,    KC_NO,    KC_NO,  KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_RSFT,
        KC_NO,     KC_NO,  KC_NO,  KC_NO,   KC_NO,          KC_NO,          KC_LSFT,      KC_BSPC, KC_RALT, KC_NO,   KC_RCTL, KC_NO
    ),
    [4] = LAYOUT(
