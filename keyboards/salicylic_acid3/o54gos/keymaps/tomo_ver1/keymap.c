...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        CTR2TB,  KC_A,    KC_S,    KC_D,    KC_F,      KC_G,   KC_PIPE,    KC_QUOT,  KC_H,  KC_J,   KC_K,    KC_L,    KC_SCLN, KC_ENT,
    ...
    [1] = LAYOUT(
        JPZKHK,    KC_NO,  KC_F2,  KC_F3,   KC_F4,   KC_F5,    KC_NO,    KC_NO,  KC_F6,   KC_F7,   KC_F8,   KC_F9,   SCP,     KC_BSLS,
    ...
    [2] = LAYOUT(
        KC_GRV,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_NO,    KC_NO,  KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    JP_YEN,
        KC_LCTL,   KC_SLSH, KC_COMM, KC_DOT,  KC_MINS, KC_EQL,  KC_NO,    KC_NO,  KC_COLN, KC_QUOT, KC_TILD, KC_LBRC, KC_RBRC, KC_PIPE,
        KC_LSFT,   KC_QUES, KC_LABK, KC_RABK, KC_UNDS, KC_PLUS, KC_NO,    KC_NO,  KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_RSFT,
