...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LOWER] = LAYOUT(
        JPZKHK,  KC_NO,  KC_F2,  KC_F3,   KC_F4,   KC_F5,  KC_NO, KC_F6,   KC_F7,   KC_F8,   KC_F9,   SCP,     JP_YEN,
    ...
    [_RAISE] = LAYOUT(
        ...
        KC_LCTL,   KC_SLSH, KC_COMM, KC_DOT,  KC_MINS, KC_EQL,  KC_NO, KC_COLN, KC_QUOT, KC_TILD, KC_LBRC, KC_RBRC, KC_BSLS,
        KC_LSFT,   KC_QUES, KC_LABK, KC_RABK, KC_UNDS, KC_PLUS, KC_NO, KC_PIPE, KC_DQT,  KC_NO,   KC_NO,   KC_NO,   KC_RSFT,
