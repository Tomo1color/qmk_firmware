...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT(
        ...
        KC_BSPC,   KC_DEL, KC_LALT, KC_LGUI, LT(_LOWER, KC_ENT), SF2SP, SF2SP, MO(_RAISE), KC_RALT, KC_LEFT, KC_DOWN, KC_RGHT
    ),
    ...
    [_RAISE] = LAYOUT(
        ...
        KC_LCTL,   KC_SLSH, KC_LABK, KC_RABK, KC_MINS, KC_EQL,  KC_NO, KC_COLN, KC_QUOT, KC_LBRC, KC_RBRC, KC_BSLS, KC_ENT,
        KC_LSFT,   KC_HOME, KC_PGDN,  KC_PGUP, KC_END, KC_PLUS, KC_NO, KC_PIPE, KC_DQT,  KC_NO,   KC_NO,   JP_YEN,  KC_RSFT,
    ...
    [_ADJUST] = LAYOUT(
      ...
      JIS_TO_US,   KC_NO,  KC_NO,  QK_BOOT, KC_NO,     KC_NO, KC_RSFT,       KC_BSPC,  KC_RALT, KC_HOME, KC_PGDN, KC_END
    )
};
