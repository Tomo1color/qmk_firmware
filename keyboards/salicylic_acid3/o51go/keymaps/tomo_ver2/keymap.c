 ...
 *
 * Build command
 * $ make salicylic_acid3/o51go:tomo_ver2
 * $ qmk compile -kb salicylic_acid3/o51go -km tomo_ver2
 *
 * Upload command
 * $ make salicylic_acid3/o51go:tomo_ver2:flash
 */

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT(
        KC_ESC,   KC_Q,    KC_W,    KC_E,    KC_R, KC_T, KC_NO, KC_Y, KC_U, KC_I,    KC_O,   KC_P,    KC_BSPC,
        CTR2TB,   KC_A,    KC_S,    KC_D,    KC_F, KC_G, KC_NO, KC_H, KC_J, KC_K,    KC_L,   MT(MOD_RCTL, KC_SCLN), KC_ENT,
        KC_LSFT,  KC_Z,    KC_X,    KC_C,    KC_V, KC_B, KC_NO, KC_N, KC_M, KC_COMM, KC_DOT, KC_UP,   KC_SLSH,
        KC_BSPC,  KC_LCTL, GUIDEL,  ALTTAB,  LT(_LOWER, KC_ENT), SF2SP, SF2SP, MO(_RAISE), KC_RALT, KC_LEFT, KC_DOWN, KC_RGHT
    ),

    [_LOWER] = LAYOUT(
        JPZKHK,  KC_NO,  KC_F2,  KC_F3,   KC_F4,   KC_F5,  KC_NO, KC_F6,   KC_F7,    KC_F8,   KC_F9,   SCP,     KC_BSPC,
        CTR2F11, SF2F12, SGUI_L, GUI_BS,  KC_LGUI, KC_F10, KC_NO, KC_LEFT, KC_DOWN,  KC_UP,   KC_RGHT, MT(MOD_RCTL, KC_PMNS), KC_ENT,
    ...
    [_RAISE] = LAYOUT(
        KC_GRV,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_NO, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSPC,
        KC_LCTL,   KC_SLSH, KC_LABK, KC_RABK, KC_MINS, KC_EQL,  KC_NO, KC_COLN, KC_QUOT, KC_LBRC, KC_RBRC, MT(MOD_RCTL, KC_BSLS), KC_ENT,
        KC_LSFT,   KC_GRV,  KC_TILD, KC_NO,   KC_UNDS, KC_PLUS, KC_NO, KC_PIPE, KC_DQT,  KC_NO,   KC_NO,   JP_YEN,  KC_RSFT,
        US_TO_JIS, KC_LCTL, KC_LGUI, KC_LALT, MO(_ADJUST),     KC_LSFT,   KC_NO,      KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO
    ),

    [_ADJUST] = LAYOUT(
        KC_NO,     KC_NO,  KC_F2,  KC_F3,   KC_F4,   KC_F5,  KC_NO,  KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_CAPS, KC_BSPC,
        KC_LCTL,   KC_F12, KC_F11, KC_F10,  KC_LGUI,  KC_NO,  KC_NO,  KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_RCTL, KC_ENT,
        KC_LSFT,   KC_NO,  KC_NO,  KC_NO,   KC_NO,    KC_NO,  KC_NO,  KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_RSFT,
      JIS_TO_US,   KC_NO,  KC_NO,  QK_BOOT, KC_NO,       KC_NO,     KC_RSFT,   KC_BSPC, KC_RALT, KC_NO,   KC_NO,   KC_NO
    )
};
