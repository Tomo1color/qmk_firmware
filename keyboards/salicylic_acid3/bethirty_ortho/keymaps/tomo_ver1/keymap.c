 ...
 *
 * Build command
 * $ make salicylic_acid3/bethirty_ortho:tomo_ver1
 *
 * Upload command
 * $
 */
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        KC_Z,    KC_X,    KC_C,    KC_V,         KC_B,   KC_N,    KC_M,  KC_COMM, KC_DOT,  MT(MOD_LCTL, KC_BSPC),
        KC_LCTL, GUIDEL,  ALTTAB,  LT(1, KC_ENT),    SF2SP,       MO(2), KC_RALT, KC_RGUI, KC_NO
    ),
    [1] = LAYOUT(
        KC_ESC,    KC_F2,   KC_F3,   KC_F4,      KC_F5,  KC_F6,   KC_F7,   KC_F8,   JPZKHK,    SCP,
        SF2F12,    SGUI_L,  GUI_BS,  KC_LGUI,    KC_NO,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT,  KC_MINS,
        CTL_Z,     CTL_X,   CTL_C,   CTL_V,      KC_NO,  KC_NO,   KC_DEL,  KC_NO,   KC_NO,    KC_RCTL,
        JIS_TO_US, KC_NO,   KC_NO,   KC_NO,          CMDSP,       KC_BSPC, KC_RALT, KC_RGUI, KC_NO
    ),
    [2] = LAYOUT(
        KC_1,      KC_2,    KC_3,    KC_4,       KC_5,      KC_6,    KC_7,    KC_8,    KC_9,    KC_0,
        MT(MOD_LCTL, KC_SLSH),   KC_LABK, KC_RABK, KC_MINS,    KC_EQL,    KC_COLN, KC_QUOT, KC_LBRC, KC_RBRC, KC_BSLS,
    ...
    [3] = LAYOUT(
        ...
        KC_NO,     KC_NO,   KC_NO,   KC_NO,      KC_NO,  KC_NO,      KC_NO,   KC_NO,   KC_NO,    KC_RCTL,
        US_TO_JIS, KC_NO,   KC_NO,   KC_NO,          KC_LSFT,        KC_NO,   KC_RALT, KC_RGUI,  KC_NO
    ),
    [4] = LAYOUT(
