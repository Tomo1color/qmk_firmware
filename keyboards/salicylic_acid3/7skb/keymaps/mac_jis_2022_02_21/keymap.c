...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+---------+---------+--------+--------|   |--------+--------+--------+--------+--------+--------+--------+--------|
     KC_LCTRL, KC_LSFT, KC_LANG2,   GUI_BS, XXXXXXX, XXXXXXX,     KC_LEFT, KC_DOWN,   KC_UP,KC_RIGHT, WN_MINS, JP_ASTR, ALT_ENT,
  //|--------+--------+---------+---------+--------+--------|   |--------+--------+--------+--------+--------+--------+--------|
  ...
  //|--------+----------------+--------+--------+--------+--------|   |--------+--------+--------+--------+--------+--------+--------+--------|
     KC_LCTRL,  LSFT_T(KC_F12), KC_ZKHK, KC_ZKHK, XXXXXXX,  JP_YEN,     XXXXXXX,  JP_EQL, JP_LBRC, JP_RBRC, JP_PIPE,  JP_GRV, _______,
  //|--------+----------------+--------+--------+--------+--------|   |--------+--------+--------+--------+--------+--------+--------|
