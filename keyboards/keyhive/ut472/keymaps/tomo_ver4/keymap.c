 ...
 *
 * Build command
 * $ make keyhive/ut472:tomo_ver4
 *
 * Upload command
 * $ make keyhive/ut472:tomo_ver4:dfu
 */
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT(
		...
		KC_LSFT,              KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_UP, MT(MOD_RSFT, KC_SLSH),
		      KC_LCTL, KC_DEL, KC_LALT, KC_LGUI, LT(3, KC_SPC), LT(1, KC_SPC), LT(2, KC_SPC), KC_RALT, KC_LEFT, KC_DOWN, KC_RGHT
	),
	...
	[1] = LAYOUT(
	  ...
	  _______, KC_COMM, KC_DOT,  KC_SLSH, KC_UNDS, KC_EQL,  KC_NO,   KC_SCLN, KC_LCBR, KC_RCBR, KC_PIPE, _______,
	        JIS_TO_US, _______, _______, _______, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO
	),

	[2] = LAYOUT(
	 KC_TILD, KC_EXLM, KC_AT, KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_LPRN, KC_RPRN, KC_BSLS, _______,
	 KC_LCTL, KC_NO,   KC_NO, KC_NO,   KC_DQT,  KC_EQL,  KC_ASTR, KC_SCLN, KC_LCBR, KC_RCBR, KC_PIPE, _______,
	 _______, KC_NO,   KC_NO, KC_NO,   KC_QUOT, KC_PLUS, KC_NO,   KC_COLN, KC_NO,   KC_NO,   KC_NO,   _______,
          US_TO_JIS, _______, _______, _______, SFTSP, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO
	),
	...
	[3] = LAYOUT(
		...
		_______,        KC_NO,          KC_NO,  KC_NO,  KC_NO,   KC_NO, KC_UNDS, KC_DEL,  KC_NO, KC_NO,   KC_NO,   KC_RSFT,
		      KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, CMDSP, KC_BSPC, KC_LALT, KC_NO, KC_NO, KC_NO
	)
};
